...
using XamarinUniverse.Mobile.Interfaces;
using XamarinUniverse.Mobile.Resources;
    ...
    public class NewsViewModel : BaseViewModel, ISupportIncrementalLoading
    {
        ...
        private async Task PostCommentAsync()
        {
            try
            {
                ...
                {
                    await Application.Current.MainPage.DisplayAlert(Resource.CommentDialogNotAuthorizedTitle, Resource.CommentDialogNotAuthorizedMessage, Resource.DialogOk);
                }
            }
            finally
            {
